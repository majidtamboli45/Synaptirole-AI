...
> Source: https://www.geeksforgeeks.org/nlp/amazon-product-reviews-sentiment-analysis-in-python/
...
---  ------     --------------  ----- 
 ...
 1   Sentiment  25000 non-null  int64 Now, To drop the null values (if any), run the below command.
