...
- Commonly used to protect fields and implementation details.
class Person {
    // private variable
    private String name;
...
If no access modifier is specified, this means only classes within the same package can access it.
- Provides more access than private but less than protected and public.
- Cannot be directly accessed from classes in other packages.
class Car {
...
- Commonly used for methods or classes intended to be accessed externally.
