...
> Source: https://www.geeksforgeeks.org/machine-learning/polynomial-regression-from-scratch-using-python/
...
h(x) = w \cdot x here, x is the feature vector. and w is the weight vector.
...
h(x) = w_1 x_1 + w_2 x_2 + \cdots + w_n x_n here, w is the weight vector. where x2 is the derived feature from x.
